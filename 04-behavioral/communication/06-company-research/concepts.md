...
```mermaid
graph LR
    subgraph Impact["Impact of Research Quality"]
        A["No Research<br/>'I heard it's a<br/>great company'"] --> |Weak signal| R1["Rejection or<br/>lukewarm interest"]
        B["Surface Research<br/>'I like your<br/>product'"] --> |Neutral signal| R2["Passes but<br/>doesn't impress"]
        C["Deep Research<br/>'I noticed your migration<br/>to Kubernetes and I've<br/>led similar work'"] --> |Strong signal| R3["Memorable<br/>candidate"]
    end
...
```mermaid
graph TD
    subgraph Framework["The Three-Layer Answer"]
        L1["Layer 1: WHAT<br/>What specifically excites you<br/>about the company<br/>(product, mission, technical challenges)"]
        L2["Layer 2: WHY<br/>Why it connects to<br/>your career goals and values<br/>(growth, impact, domain interest)"]
        L3["Layer 3: HOW<br/>How your specific skills<br/>and experience add value<br/>(concrete contribution)"]
    end
...
```mermaid
graph LR
    subgraph Mapping["Value Mapping Process"]
        V["Company<br/>Values"] --> M["Match to<br/>Your Stories"]
        M --> T["Tailor the<br/>Emphasis"]
        T --> P["Practice the<br/>Tailored Version"]
    end
