...
```mermaid
graph LR
    A[01 STAR Method] --> B[02 System Design<br/>Presentation]
...
```mermaid
graph TD
    subgraph Phase1["Phase 1: Foundation (Days 1-2)"]
        S1[01 STAR Method]
        S2[06 Company Research]
    end

    subgraph Phase2["Phase 2: Story Building (Days 3-5)"]
        S3[03 Conflict Resolution]
        S4[04 Failure Stories]
        S5[05 Leadership Without Authority]
    end

    subgraph Phase3["Phase 3: Presentation (Days 6-7)"]
        S6[02 System Design Presentation]
    end
