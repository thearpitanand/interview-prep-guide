...
| #   | Topic                     | Folder                                                 | Days  | Problems     | Priority |
| --- | ------------------------- | ------------------------------------------------------ | ----- | ------------ | -------- |
| 00  | Python Basics             | [00-python-basics](./00-python-basics)                 | 1-3   | 12 exercises | VV IMP   |
| 01  | Arrays & Bit Manipulation | [01-arrays-and-bits](./01-arrays-and-bits)             | 4-8   | ~30          | VV IMP   |
| 02  | Strings                   | [02-strings](./02-strings)                             | 9-11  | ~18          | VV IMP   |
| 03  | Searching & Sorting       | [03-searching-and-sorting](./03-searching-and-sorting) | 12-14 | ~18          | VV IMP   |
| 04  | Matrix                    | [04-matrix](./04-matrix)                               | 15-16 | ~9           | IMP      |
| 05  | Linked List               | [05-linked-list](./05-linked-list)                     | 17-19 | ~18          | VV IMP   |
| 06  | Stacks & Queues           | [06-stacks-and-queues](./06-stacks-and-queues)         | 20-22 | ~18          | VV IMP   |
| 07  | Binary Trees              | [07-binary-trees](./07-binary-trees)                   | 23-25 | ~20          | VV IMP   |
| 08  | BST                       | [08-bst](./08-bst)                                     | 26-27 | ~14          | VV IMP   |
| 09  | Heap                      | [09-heap](./09-heap)                                   | 28    | ~10          | VV IMP   |
| 10  | Greedy                    | [10-greedy](./10-greedy)                               | 29-30 | ~12          | IMP      |
| 11  | Backtracking              | [11-backtracking](./11-backtracking)                   | 31-32 | ~10          | IMP      |
| 12  | Graphs                    | [12-graphs](./12-graphs)                               | 33-35 | ~18          | IMP      |
| 13  | Dynamic Programming       | [13-dynamic-programming](./13-dynamic-programming)     | 36-39 | ~30          | IMP      |
...
- **VV IMP** — Tier 1, ~70% of typical interviews. Master these before applying.
- **IMP** — Tier 2, next ~20%. Required for senior / FAANG-style roles.
- **—** (blank) — Tier 3, advanced / optional. Only for top-tier prep.

Inside each topic, patterns and individual problems are tagged the same way:
`Priority: VV IMP` in `.py` docstrings and ` — VV IMP` / ` — IMP` after pattern headings in `concepts.md`.
